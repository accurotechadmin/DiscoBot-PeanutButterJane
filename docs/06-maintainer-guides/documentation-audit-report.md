...
| `../01-user-guides/` | GitHub checkout-to-running-bot path, installation, configuration, invite, run, command usage, troubleshooting. | 5 | User configuration distinguishes `.env` presence from defaulted effective values, and the full setup guide consolidates first-run readiness and extension checks. |
