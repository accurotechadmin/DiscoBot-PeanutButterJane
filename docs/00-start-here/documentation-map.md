...
| --- | --- | --- |
| Go from GitHub checkout to a responding bot | [From GitHub to a running bot](../01-user-guides/from-github-to-running-bot.md) | [Quick start](../01-user-guides/quick-start.md), [Installation](../01-user-guides/installation.md), [Configuration](../01-user-guides/configuration.md) |
| Run the bot once | [Quick start](../01-user-guides/quick-start.md) | [Installation](../01-user-guides/installation.md), [Configuration](../01-user-guides/configuration.md) |
...
| Operate a long-running process | [Running in long-lived sessions](../02-operator-guides/running-in-long-lived-sessions.md) | [Logging and log levels](../02-operator-guides/logging-and-log-levels.md) |
...
| Role | Reading path |
| --- | --- |
| User | Start here -> GitHub-to-running guide -> quick start -> configuration -> built-in commands -> troubleshooting. |
| Operator | Environment -> secrets -> startup validation -> logging -> long-lived sessions -> dependency management. |
